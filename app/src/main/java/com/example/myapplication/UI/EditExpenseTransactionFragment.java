...
public class EditExpenseTransactionFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_edit_transaction_expense, container, false);
    }
    ...
    private void setupCategoryRecycler() {
        List<Category> categories = EditTransactionFragment.CategoryProvider.getExpenseCategories();
